...
#define kTagBitsByte              ((Word)5)
#define kTagBitsObject            ((Word)6)
#define kTagBitsBits              ((Word)7)
...
#define AsTaggedObject(p) ((AsWord(p) & ~(kTagBitsMask << kTagBitsShift)) | ((kTagBitsObject & kTagBitsMask)<<kTagBitsShift))
...
#define AsUntaggedObject(w) (AsPointer(AsWord(w) & ~(kTagBitsMask<<kTagBitsShift)))
